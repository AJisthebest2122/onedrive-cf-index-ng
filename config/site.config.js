...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'Anshjoshi@1m0ssz.onmicrosoft.com',
  ...
  protectedRoutes: ['/PERSONAL FILES', '/Demo/😎Another Private Folder Password 123'],
